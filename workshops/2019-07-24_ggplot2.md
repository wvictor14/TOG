...
1. **Data**. A dataframe of variables to be visualized
...
ggplot(data = data, aes(x = diagnosis, y = cg20970886, fill = maternal_ethnicity)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitterdodge(dodge.width = 0.75, jitter.width = 0.1), 
             aes(group = maternal_ethnicity, color = maternal_ethnicity))
```
...
## scale_fill_discrete requires an  n-length, n = number of levels of a factor
fill_vector <- setNames(object = c('#32a6a8', '#e8e846'), 
                        nm = unique(data$diagnosis))
...
![](2019-07-24_ggplot2_files/figure-html/unnamed-chunk-5-5.png)<!-- -->
...
ggplot(data = data, aes(x = diagnosis, y = cg20970886, fill = diagnosis)) +
  ...
  scale_color_manual(values = fill_vector) +
  scale_fill_manual(values = fill_vector, name = '') +
  scale_y_continuous(limits = c(0, 1), breaks = c(0, 0.5, 1), labels = c(0, 50, 100),
                     name = '% methylation') +
  scale_x_discrete(labels = c('controls', 'cases'), name = '')
```

![](2019-07-24_ggplot2_files/figure-html/unnamed-chunk-5-6.png)<!-- -->
...
![](2019-07-24_ggplot2_files/figure-html/unnamed-chunk-5-7.png)<!-- -->
...
![](2019-07-24_ggplot2_files/figure-html/unnamed-chunk-5-8.png)<!-- -->
...
![](2019-07-24_ggplot2_files/figure-html/unnamed-chunk-5-9.png)<!-- -->
